...
def generare_judete():
    ...
    judet_final=random.randint(1,42)
    return judet_final

def generare_an():
    # în funcția generare an se generează anul, bazat pe categorii de varsta si probabilitatea de a apare într-o categorie
...
def generare_luna_zi():
    luna_finala=random.randint(1,12)
    if luna_finala==2:
        zi_finala=random.randint(1,28)
    if luna_finala== 4 or luna_finala==6 or luna_finala==9 or luna_finala==11:
        zi_finala = random.randint(1, 30)
    if luna_finala==1 or luna_finala==3 or luna_finala==5 or luna_finala==7 or luna_finala==8 or luna_finala==10 or luna_finala==12:
